...
class SimulationManager:
    ...
    def setup_scenario(self, vehicle_model, vehicle_config=None, spawn_target=False):
        ...
        self.scenario.add_vehicle(self.base_vehicle, pos=(5.660,5,100.928), rot_quat=(0, 0, 1, 0))
        ...
        if spawn_target:
            ...
            self.scenario.add_vehicle(self.target_vehicle, pos=(5.660,5,100.928), rot_quat=(0, 0, 1, 0))
