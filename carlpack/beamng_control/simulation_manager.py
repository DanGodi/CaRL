...
class SimulationManager:
    ...
    def setup_scenario(self, vehicle_model, vehicle_config=None, spawn_target=False):
        ...
        self.scenario.add_vehicle(self.base_vehicle, pos=(-38.895,-188.583, 100.928), rot_quat=(0, 0, 0.7071, 0.7071))
        ...
        if spawn_target:
            ...
            self.scenario.add_vehicle(self.target_vehicle, pos=(-38.895,-188.583, 100.928), rot_quat=(0, 0, 0.7071, 0.7071))
