...
\title{CaRL: reinforcement learning for car mimicry} % Poster title

\author{Dan Godi} % Author(s)

\institute{Physics department, Weizmann Institute of Science} % Institution(s)
...
\begin{column}{\onecolwid} % The first columna
